    ...
    alter table tarjeta_usuario 
       add constraint FK82ecd2plweg4jm7vo9kiwcin2 
       foreign key (usuario_id) 
       references usuario (ci)

    alter table tarjeta_usuario 
       add constraint FK124lbi91sd8atgigka8e83hfm 
       foreign key (tarjeta_id) 
       references tarjeta (n_tarjeta)
